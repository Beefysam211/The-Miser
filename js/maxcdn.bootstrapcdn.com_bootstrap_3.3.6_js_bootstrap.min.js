...
var c='[data-dismiss="alert"]',d=function(b){a(b).on("click",c,this.close)};(d.VERSION="3.3.6"),(d.TRANSITION_DURATION=150),(d.prototype.close=function(b){function c(){g.detach().trigger("closed.bs.alert").remove()}
